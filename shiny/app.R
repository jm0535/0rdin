    ...
    div(
      ...
      div(
        ...
        div(
          ...
          div(
            id = "tab-beta", class = "tab-content", style = "display: none;",
          ...
          # RESULTS TAB
          div(
            id = "tab-results", class = "tab-content", style = "display: none;",
            h2(style = "color: #2e8b57; margin-bottom: 20px;", "📋 Analysis Results"),
            div(
              style = "background: #252526; padding: 30px; text-align: center;",
